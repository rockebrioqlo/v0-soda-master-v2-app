...
export function DashboardPage() {
  ...
  const estadoMesas = [
    { name: 'Libres', value: mesas.filter(m => m.estado === 'libre').length, color: '#22c55e' },
          ...
          <Card className="border-zinc-700 bg-zinc-800/50">
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{formatCurrency(ventasHoy || 150000)}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-zinc-700 bg-zinc-800/50">
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{comandasHoy.length || 24}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-zinc-700 bg-zinc-800/50">
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{formatCurrency(ticketPromedio || 6250)}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-zinc-700 bg-zinc-800/50">
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{mesasOcupadas} / {mesas.length}</p>
              </div>
            </CardContent>
          </Card>
        </div>
